		...
		<script>window.jQuery || document.write('<script src="<?php echo base_url(); ?>assets/front/tpl_adinspector/js/jquery-1.11.0.min.js"><\/script>')</script>
		...
		<script type="text/javascript" src="<?php echo base_url(); ?>assets/front/tpl_adinspector/js/formValidation.min.js"></script>
		<script type="text/javascript" src="<?php echo base_url(); ?>assets/front/tpl_adinspector/js/framework/bootstrap.min.js"></script>

		<script type="text/javascript" src="<?php echo base_url(); ?>assets/front/tpl_adinspector/js/script.js"></script>
	</body>
</html>